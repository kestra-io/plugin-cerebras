...
@Plugin(
    examples = {
        @io.kestra.core.models.annotations.CerebrasTask(
            title = "Simple revert",
            code = { "format: \"Text to be reverted\"" }
        )
    }
)
public class CerebrasTask extends Task implements RunnableTask<CerebrasTask.Output> {
    @Schema(
    ...
    @Override
    public CerebrasTask.Output run(RunContext runContext) throws Exception {
